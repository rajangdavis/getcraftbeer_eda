...
beers.name AS beer_name, 
breweries.name AS brewery_name, 
styles.name from beers,breweries, styles 
WHERE beers.brewery_id = breweries.id 
AND beers.style_id = styles.id 
...
beers.name AS beer_name, 
breweries.name AS brewery_name,
reviews.review_overall as overall,
reviews.review_taste as taste,
reviews.review_aroma as aroma,
reviews.review_appearance as appearance,
