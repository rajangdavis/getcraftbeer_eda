...
Most of my EDA was performed using [Postgres directly](sql_queries.sql); however, I started looking at how to plot the beer varieties within a [given area](notebooks/Data%20Visualization.ipynb).
